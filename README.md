...
**Para obtener más información detallada, visita la [Wiki del proyecto](https://github.com/pabloseijo/Medication-Tracker/wiki).**  
Este README ofrece una guía introductoria, mientras que la Wiki contiene documentación ampliada sobre la API, estructura de la base de datos, preguntas frecuentes y más.
...
Los usuarios pueden actualizar su perfil en cualquier momento desde la sección **Perfil**. Para ello:
  - Acceder a la pestaña **Perfil** en la barra de navegación inferior.
  - Editar datos personales como nombre, edad, peso, altura y condiciones médicas.
